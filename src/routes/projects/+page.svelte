    ...
    <div class="grid grid-cols-3 gap-4">
        <div class="bg-gray-100 p-4 rounded text-center">
            ...
            <P class="my-4">Amori is a short, story-centered game heavily inspired by the game Omori 
                made by Omocat. It was the final project for my grade 10 computer science
                culminating project. Me and my parter had a lot of fun using processing
                to its fullest capabilities to make a game that we both enjoyed at the end.<br><br>
                <a href="https://github.com/a0euhtns/amori" class="text-blue-500 text-lg">Learn More</a>
            </P>
        ...
        <div class="bg-yellow-100 p-4 rounded text-center">
            ...
            <P class="my-4">LearnAI.js is a javascript library I helped make for my grade 11 computer science
                ...
                <a href="https://github.com/vsarca-school/2022-ICS3-Final-Project" class="text-blue-500 text-lg">Learn More</a>
            </P>
